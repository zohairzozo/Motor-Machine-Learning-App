...
with model_training:
    ...
    with future:
        ...
        a = st.number_input("Input a value of Volatge" ,min_value=15, max_value=40,)
        b = st.number_input("Input a value of Testing Current ", min_value=1, max_value=5)
        c = st.number_input("Input a value of Motor Temperature",min_value=15, max_value=60)
        d = st.number_input("Input a value of Motor Humidity",min_value=30, max_value=100)
    ...
    with accuracy:
        ...
        st.write('Score for Training data = ', f1)
